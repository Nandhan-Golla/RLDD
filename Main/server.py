        ...
        if file and allowed_file(file.filename):
            ...
            try:
                ...
                for step in range(5):
                    ...
                    steps.append(f"Step {step+1}: Drug {action}, Reward {reward:.2f}, Hgb {info['new_hemoglobin']:.1f}, Glu {info['new_glucose']:.1f}")
                    if terminated:
                        break
...
if not os.path.exists("ppo_drug_discovery_advanced.zip"):
